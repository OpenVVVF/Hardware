...
void MX_ADC1_Init(void)
{
  ...
  */
  hadc1.Instance = ADC1;
  /* ADCCLK = PLL2P / 2 = 48 MHz (max 50 MHz per datasheet). */
...
void MX_ADC2_Init(void)
{
  ...
  */
  hadc2.Instance = ADC2;
  /* ADCCLK = PLL2P / 2 = 48 MHz (shared ADC12 clock, max 50 MHz). */
...
void MX_ADC3_Init(void)
{
  ...
  */
  hadc3.Instance = ADC3;
  /* ADCCLK = PLL2P / 4 = 24 MHz. DIV1 would be 96 MHz, above the 50 MHz max. */
