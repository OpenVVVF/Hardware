...
(library Library_1
	...
	(patternDef "CAPPRD750W80D1800H3700" (originalName "CAPPRD750W80D1800H3700")
		...
		(layerContents (layerNumRef 28)
			(arc (pt 3.75, 0) (radius 9) (startAngle 0.0) (sweepAngle 0.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 3.75, 0) (radius 9) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
	)
	...
	(compDef "UCS2D331MHD" (originalName "UCS2D331MHD") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://www.nichicon.co.jp/english/series_items/catalog_pdf/e-ucs.pdf")
		(attr "<Component Height>" "37")
		(attr "<STEP Filename>" "UCS2D331MHD.stp")
