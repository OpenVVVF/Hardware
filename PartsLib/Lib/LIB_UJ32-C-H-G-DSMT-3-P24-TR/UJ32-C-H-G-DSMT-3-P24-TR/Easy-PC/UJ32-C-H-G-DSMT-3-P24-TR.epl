SamacSys ECAD Model
19928838/1553794/2.50/28/2/Connector
...
(library Library_1
	...
	(compDef "UJ32-C-H-G-DSMT-3-P24-TR" (originalName "UJ32-C-H-G-DSMT-3-P24-TR") (compHeader (numPins 28) (numParts 1) (refDesPrefix J)
		...
		(attr "Description" "UJ32-C-H-G-DSMT-3-P24-TR - Type C, USB 3.2 Gen 1, 5 Gbps, 48 Vdc, 5 A, Horizontal, Hybrid Mount Mounting Style, Hybrid MountContact Pin Type, Gold Plated 3 in, 24 Pins, USB Receptacle")
		(attr "Datasheet Link" "https://www.sameskydevices.com/product/resource/UJ32-C-H-G-DSMT-3-P24-TR.pdf")
		(attr "Height" "3.36 mm")
	)
