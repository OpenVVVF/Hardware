 ...
 */
 ...
 FocController::FocController()
     : _ElectricalAngle_Rad(0.0f), _ElectricalSpeed_RadPerSec(0.0f),
       ...
       _IdCommanded_A(0.0f), _IqCommanded_A(0.0f), _Vd_V(0.0f), _Vq_V(0.0f),
       _Valpha_V(0.0f), _Vbeta_V(0.0f), _PhaseCurrentLimited(false),
       _DcBusCurrentLimited(false), _VdDecouplingFF_V_(0.0f), _VqDecouplingFF_V_(0.0f) {
 ...
 void FocController::CalculateDecoupling() {
     ...
     _VqDecouplingFF_V_ = _ElectricalSpeed_RadPerSec * MotorConfig_._Ld_Henry * _Id_A + _ElectricalSpeed_RadPerSec * MotorConfig_._FluxLinkage_Wb;
 }
 ...
 ModulationInput FocController::Update(const SensorData& _Sensors, const DriveCommand& _Cmd, float _dt_S) {
     ...
     // --- Dynamic PI Limit Resolution ---
     // Uses the explicitly set soft limit, or defaults to the hardware max from MotorConfig.
     ...
     if (_ElectricalAngle_Rad < 0.0f) _ElectricalAngle_Rad += 2.0f * 3.1415926535f;
     ...
     _Clarke_.fA = Sensors_._Iu_A; _Clarke_.fB = Sensors_._Iv_A; _Clarke_.fC = Sensors_._Iw_A;
     _Clarke_.m_abc2albe(&_Clarke_);
     _Ialpha_A = _Clarke_.fAl; i_alpha = _Ialpha_A;
     _Ibeta_A = _Clarke_.fBe;  i_beta = _Ibeta_A;
 
     _Park_.fAl = _Ialpha_A; _Park_.fBe = _Ibeta_A;
     _Park_.fSinAng = _SinTheta_unitless; _Park_.fCosAng = _CosTheta_unitless;
     ...
     _InversePark_.fD = _Vd_V; _InversePark_.fQ = _Vq_V;
     _InversePark_.fSinAng = _SinTheta_unitless; _InversePark_.fCosAng = _CosTheta_unitless;
     _InversePark_.m_dq2albe(&_InversePark_);
     _Valpha_V = _InversePark_.fAl; _Vbeta_V = _InversePark_.fBe;
