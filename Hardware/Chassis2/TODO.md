...
- [ ] Fix and finalize internal part numbers for the DC link module holders.
  ...
  - `HW-C2-DCLMH-200-PRINTED-B` is registered (`part_numbers.json`); the 250-450V
...
- [ ] Design actual DC link module holder geometry in FreeCAD.
  ...
  - `Mechanical/Fab/HW-C2-DCLMH-250-450-PRINTED-A/` is a placeholder: info.txt only,
    no STEP/CAD yet — geometry is designed (InverterMechanical.FCStd); export STEP/STL
    into the folder before release. Same for `HW-C2-DCLMH-250-450-SPCR-PRINTED-A/`.
